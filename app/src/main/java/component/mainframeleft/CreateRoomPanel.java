...
public class CreateRoomPanel {
  ...
  public void init() {
    ...
    // review: the app itself SHOULD save user's token
    // userTokenLabel
    ...
    // review: the same as above
    // userTokenTextField
    JTextField userTokenTextField = new JTextField("", 10);
    ...
    // roomNameTextField
    JTextField roomNameTextField = new JTextField("", 10);
